import{j as t}from"./index-CtRM5gEA.js";const l={type:"playground",title:"Browser Terminal",description:"A fully functional terminal emulator in a browser tab.",summary:"A fully functional terminal emulator in a browser tab.",status:"published",publishedAt:"2025-02-01",tags:["Prototype"],cover:"https://images.unsplash.com/photo-1629654297299-c8506221ca97?w=600&h=500&fit=crop&auto=format&q=80",layout:{desktop:"col-start-3 col-span-1 row-start-1 row-span-1",mobile:"col-span-1 row-span-1"}};function r(n){const e={code:"code",h2:"h2",p:"p",pre:"pre",...n.components};return t.jsxs(t.Fragment,{children:[t.jsx(e.h2,{children:"Idea"}),`
...
`,t.jsx(e.p,{children:"Every time you open vim and close it without seeing your previous terminal output get corrupted, you're benefiting from the alternate screen buffer. I never thought about how that worked until I built this."})]})}function c(n={}){const{wrapper:e}=n.components||{};return e?t.jsx(e,{...n,children:t.jsx(r,{...n})}):r(n)}const d=Object.freeze(Object.defineProperty({__proto__:null,default:c,frontmatter:l},Symbol.toStringTag,{value:"Module"})),h={type:"playground",title:"DNS Resolution Explainer",description:"Step-by-step walkthrough of how a DNS query resolves across the internet.",summary:"Step-by-step walkthrough of how a DNS query resolves across the internet.",status:"published",publishedAt:"2025-04-01",tags:["Explainer"],cover:"https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=900&h=450&fit=crop&auto=format&q=80",layout:{desktop:"col-start-3 col-span-2 row-start-2 row-span-1",mobile:"col-span-2 row-span-1"}};function s(n){const e={code:"code",h2:"h2",p:"p",pre:"pre",...n.components};return t.jsxs(t.Fragment,{children:[t.jsx(e.h2,{children:"Idea"}),`
...
`,t.jsx(e.p,{children:"The other thing that becomes obvious: DNS is almost entirely cache hits. A busy recursive resolver might have millions of cached entries. Most domains you visit have their IP cached from someone else's query. The full resolution chain is surprisingly rare in practice."})]})}function u(n={}){const{wrapper:e}=n.components||{};return e?t.jsx(e,{...n,children:t.jsx(s,{...n})}):s(n)}const p=Object.freeze(Object.defineProperty({__proto__:null,default:u,frontmatter:h},Symbol.toStringTag,{value:"Module"})),m={type:"playground",title:"Graph Explorer",description:"Interactive BFS and DFS on user-defined graphs.",summary:"Interactive BFS and DFS on user-defined graphs.",status:"published",publishedAt:"2025-03-01",tags:["Algorithm"],cover:"https://images.unsplash.com/photo-1509228468518-180dd4864904?w=600&h=500&fit=crop&auto=format&q=80",layout:{desktop:"col-start-4 col-span-1 row-start-1 row-span-1",mobile:"col-span-1 row-span-1"}};function o(n){const e={code:"code",h2:"h2",p:"p",pre:"pre",...n.components};return t.jsxs(t.Fragment,{children:[t.jsx(e.h2,{children:"Idea"}),`
...
`,t.jsxs(e.p,{children:["The visual that surprised me most: insertion sort is ",t.jsx(e.em,{children:"fast"})," on nearly-sorted arrays. Faster than quicksort in some cases. You can see it — insertion sort barely moves elements when the array is almost sorted, while quicksort still does the full partition dance."]})]})}function x(n={}){const{wrapper:e}=n.components||{};return e?t.jsx(e,{...n,children:t.jsx(a,{...n})}):a(n)}const b=Object.freeze(Object.defineProperty({__proto__:null,default:x,frontmatter:f},Symbol.toStringTag,{value:"Module"})),j=Object.assign({"/content/playground/browser-terminal/index.mdx":d,"/content/playground/dns-resolution-explainer/index.mdx":p,"/content/playground/graph-explorer/index.mdx":g,"/content/playground/sorting-algorithm-visualizer/index.mdx":b});function i(){return Object.entries(j).map(([n,e])=>({slug:n.split("/")[3],...e.frontmatter,Component:e.default}))}function S(){return i().filter(n=>n.status==="published")}function T(n){return i().find(e=>e.slug===n&&e.status==="published")}export{T as a,S as g};
