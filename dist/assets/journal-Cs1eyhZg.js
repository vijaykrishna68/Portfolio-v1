...
`,n.jsx(e.p,{children:"The B-Tree is a beautiful piece of engineering. Once you understand what problem it's solving — minimizing disk I/O given a specific cost model — everything about its design follows logically."})]})}function d(t={}){const{wrapper:e}=t.components||{};return e?n.jsx(e,{...t,children:n.jsx(r,{...t})}):r(t)}const l=Object.freeze(Object.defineProperty({__proto__:null,default:d,frontmatter:h},Symbol.toStringTag,{value:"Module"})),c={type:"journal",title:"Designing Better APIs",description:"Predictable naming, consistent errors, and the principle of least surprise — what separates a good API from a painful one.",excerpt:"Predictable naming, consistent errors, and the principle of least surprise — what separates a good API from a painful one.",status:"published",publishedAt:"2025-04-19",tags:["Architecture"],readTime:"6 min",featured:!1};function o(t){const e={code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...t.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.p,{children:"I've integrated with a lot of APIs. Some of them I think about fondly. Most of them I have repressed."}),`
...
`,n.jsx(e.p,{children:"If the answer is different from what the endpoint actually does, that's a design problem. Good API design is empathy applied to a technical interface."})]})}function u(t={}){const{wrapper:e}=t.components||{};return e?n.jsx(e,{...t,children:n.jsx(o,{...t})}):o(t)}const p=Object.freeze(Object.defineProperty({__proto__:null,default:u,frontmatter:c},Symbol.toStringTag,{value:"Module"})),x={type:"journal",title:"The Hidden Cost of React Context",description:"Context is a great concept but a frequent performance trap. Here's why it re-renders more than you expect, and what to reach for when your component tree grows.",excerpt:"Context is a great concept but a frequent performance trap. Here's why it re-renders more than you expect, and what to reach for when your component tree grows.",status:"published",publishedAt:"2025-06-12",tags:["Frontend"],readTime:"8 min",featured:!0};function i(t){const e={code:"code",h2:"h2",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...t.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.p,{children:"React Context is one of those APIs that looks simple, performs simply, and then silently destroys your app's performance once your component tree grows past a certain size."}),`
...
`]}),`
`,n.jsx(e.p,{children:'Understanding the implementation turns "use a HashMap" from cargo-culting into a deliberate choice.'})]})}function f(t={}){const{wrapper:e}=t.components||{};return e?n.jsx(e,{...t,children:n.jsx(a,{...t})}):a(t)}const y=Object.freeze(Object.defineProperty({__proto__:null,default:f,frontmatter:j},Symbol.toStringTag,{value:"Module"})),b=Object.assign({"/content/journal/b-trees-from-first-principles/index.mdx":l,"/content/journal/designing-better-apis/index.mdx":p,"/content/journal/react-context-hidden-cost/index.mdx":m,"/content/journal/why-hashmaps-feel-magical/index.mdx":y});function s(){return Object.entries(b).map(([t,e])=>({slug:t.split("/")[3],...e.frontmatter,Component:e.default}))}function k(){return s().filter(t=>t.status==="published").sort((t,e)=>new Date(e.publishedAt).getTime()-new Date(t.publishedAt).getTime())}function I(t){return s().find(e=>e.slug===t&&e.status==="published")}function A(){return s().find(t=>t.featured&&t.status==="published")}export{k as a,I as b,T as f,A as g};
